...
const TEMAS_META={
32:{label:"Tema 32",title:"Tema 32",sub:"Competencias en tráfico · LSV (RDL 6/2015) · RGC (RD 1428/2003)",expected:256,note:"256 preguntas — Tema completoo)."},
...
35:{label:"Tema 35",title:"Tema 35",sub:"Ordenación Transportes Terrestres · Ley 16/1987",expected:247},
37:{label:"Tema 37",title:"Tema 37",sub:"Accidentes de tráfico · Causas y factores",expected:159}
};

// ── Banco de preguntas (cargado desde data/tXX.js) ──────────
const TEMA_BANKS={32:Q32,33:Q33,34:Q34};

// ── Lógica de la aplicación ──────────────────────────────────
let currentTema=32,currentIdx=0,answers={};

function loadState(){try{const r=localStorage.getItem('test_pol_local_state');if(r){const s=JSON.parse(r);currentTema=s.currentTema||32;currentIdx=s.currentIdx||0;answers=s.answers||{};}}catch(e){}}
function saveState(){try{localStorage.setItem('test_pol_local_state',JSON.stringify({currentTema,currentIdx,answers}));}catch(e){}}
